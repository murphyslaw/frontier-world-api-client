...
export type SolarSystems =
  paths["/v2/solarsystems"]["get"]["responses"]["200"]["content"][
    "application/json"
  ];

export class SolarSystemsAction extends Paginated(Get)<SolarSystems> {
  constructor(requestService: IRequestService, limit: number, offset: number) {
    ...
    super(requestService, "v2/solarsystems");
